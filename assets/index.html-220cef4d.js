...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>上述我们使用了<code>appleboy/ssh-action@master</code>来进行 ssh 连接，<code>host</code>、<code>port</code>、<code>username</code>、<code>key</code>分别对应主机地址（域名/ip）、主机端口号（如果是 22 可以省略）、用户名（服务器的登录用户名）、私钥，<code>script</code>表示连接到我们的服务器后执行的 sheel 脚本命令，可以看到我们先删除了 xxxxx 文件夹，又去拉取了我们的仓库，当然该位置使用<code>git pull</code>也是可以的，如果是私有仓库则需要对应的权限，比如设置 ssh 的免密登录 key，这部分就跟我们上述的登录正好相反了。</li><li>后续的脚本命令相信都能看明白，在此不做赘述。</li></ul>`,9)]))}const u=s(t,[["render",c],["__file","index.html.vue"]]);export{u as default};
